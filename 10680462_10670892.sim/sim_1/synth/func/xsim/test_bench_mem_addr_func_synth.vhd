...
-- Date        : Fri Mar 10 17:26:37 2023
-- Host        : DESKTOP-5831C5J running 64-bit major release  (build 9200)
-- Command     : write_vhdl -mode funcsim -nolib -force -file {C:/Users/franc/OneDrive - Politecnico di Milano/AA
--               202223/Reti
--               Logiche/Progetto_Reti_Logiche/Project_code_2023/Progetto_reti/10680462_10670892.sim/sim_1/synth/func/xsim/test_bench_mem_addr_func_synth.vhd}
...
entity datapath is
  port (
    ...
    \z_sel_reg[1]_0\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
...
architecture STRUCTURE of datapath is
  ...
  signal \reg_z_reg_n_0_[1]\ : STD_LOGIC;
...
\reg_z0_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z0_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z0_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z0_reg[3]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z0_reg[4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z0_reg[5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z0_reg[6]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z0_reg[7]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z1_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z1_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z1_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z1_reg[3]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z1_reg[4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z1_reg[5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z1_reg[6]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z1_reg[7]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z2_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z2_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z2_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z2_reg[3]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z2_reg[4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z2_reg[5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z2_reg[6]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z2_reg[7]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z3_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z3_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z3_reg[2]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z3_reg[3]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z3_reg[4]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z3_reg[5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z3_reg[6]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z3_reg[7]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\reg_z[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"1D"
    )
        port map (
...
\z_sel[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\z_sel[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFABFB0000A808"
    )
        port map (
...
architecture STRUCTURE of project_reti_logiche is
  ...
  attribute FSM_ENCODED_STATES of \FSM_sequential_cur_state_reg[0]\ : label is "receiving_w:0011,wait_mem:0100,receiving_ch2:0010,receiving_ch1:0001,initiate:0000,print_out:1001,activate_z2:0111,activate_z1:0110,activate_z3:1000,activate_z0:0101";
  attribute FSM_ENCODED_STATES of \FSM_sequential_cur_state_reg[1]\ : label is "receiving_w:0011,wait_mem:0100,receiving_ch2:0010,receiving_ch1:0001,initiate:0000,print_out:1001,activate_z2:0111,activate_z1:0110,activate_z3:1000,activate_z0:0101";
  attribute FSM_ENCODED_STATES of \FSM_sequential_cur_state_reg[2]\ : label is "receiving_w:0011,wait_mem:0100,receiving_ch2:0010,receiving_ch1:0001,initiate:0000,print_out:1001,activate_z2:0111,activate_z1:0110,activate_z3:1000,activate_z0:0101";
  attribute FSM_ENCODED_STATES of \FSM_sequential_cur_state_reg[3]\ : label is "receiving_w:0011,wait_mem:0100,receiving_ch2:0010,receiving_ch1:0001,initiate:0000,print_out:1001,activate_z2:0111,activate_z1:0110,activate_z3:1000,activate_z0:0101";
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of o_done_OBUF_inst_i_1 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of o_mem_en_OBUF_inst_i_1 : label is "soft_lutpair8";
begin
...
MYDATAPATH: entity work.datapath
     port map (
      D(0) => i_w_IBUF,
      ...
      \z_sel_reg[1]_0\(3 downto 0) => next_state(3 downto 0)
    );
